...
public class Filter extends ConsultaCicloFilter {
	...
	protected DataSet getUnidadesDeInversion() throws Exception{
		...
		controlArchivoDAO.listarUnidadesDeInversionCiclos(false,TransaccionNegocio.CICLO_BATCH_SUBASTA_DIVISAS_PERSONAL,TransaccionNegocio.CICLO_BATCH_SICADII_CLAVENET_PERSONAL,TransaccionNegocio.CICLO_BATCH_SICADII_RED_COMERCIAL);					
