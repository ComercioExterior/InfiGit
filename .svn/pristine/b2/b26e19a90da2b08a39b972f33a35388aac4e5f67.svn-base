...
public class Generar extends MSCModelExtend {
	...
	public void execute() throws Exception {
		...
		consultaSolicitudes=archivosOpsDAO.envioOperacionesORO(idOrdenes,idUniInv,TransaccionNegocio.TOMA_DE_ORDEN,StatusOrden.ENVIADA,transaccionFinanciera,trnfTipo);
	...
	public boolean isValid() throws Exception {
		...
		this.controlProceso=ControlProcesosOpsMonedaExtranjera.PROCESO_OFERTA_COBRO_ORO.getInstance();
