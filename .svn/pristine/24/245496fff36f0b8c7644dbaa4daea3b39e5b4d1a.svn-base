package  models.utilitarios.browse_archivo_servidor;
...
System.out.println("Directorio INICIAL=" + directorio + " Nombre=" );				
				if(directorio==null||directorio==""){
					...
					directorio =  parametrosRecepcionDICOM.get(ParametrosSistema.RUTA_DICOM_LIQUIDAC_ENVIO);
			System.out.println("Directorio11111=" + directorio + " Nombre=" );					
				}
				...
				//Archivo
			System.out.println("Directorio=" + directorio + " Nombre=" );
				if(directorio!=null){
