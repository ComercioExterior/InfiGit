...
public class OperCamFileTransferProxy implements org.bcv.serviceDICOM.OperCamFileTransfer_PortType {
  private String _endpoint = null;
  private org.bcv.serviceDICOM.OperCamFileTransfer_PortType operCamFileTransfer_PortType = null;
  ...
  private void _initOperCamFileTransferProxy() {
    try {
      operCamFileTransfer_PortType = (new org.bcv.serviceDICOM.OperCamFileTransfer_ServiceLocator()).getOperCamFileTransferPort();
  ...
  public org.bcv.serviceDICOM.OperCamFileTransfer_PortType getOperCamFileTransfer_PortType() {
    if (operCamFileTransfer_PortType == null)
      _initOperCamFileTransferProxy();
  ...
  public java.lang.String cargarResultadoComprobacion(byte[] arch, java.lang.String coJornada) throws java.rmi.RemoteException{
    if (operCamFileTransfer_PortType == null)
      _initOperCamFileTransferProxy();
    return operCamFileTransfer_PortType.cargarResultadoComprobacion(arch, coJornada);
  }
  
  public byte[] bajarSolicitudComprobacionBloqueo(java.lang.String coJornada) throws java.rmi.RemoteException{
    if (operCamFileTransfer_PortType == null)
      _initOperCamFileTransferProxy();
    return operCamFileTransfer_PortType.bajarSolicitudComprobacionBloqueo(coJornada);
  }
