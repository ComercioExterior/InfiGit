...
public class Browse extends ConsultaCicloPorParametroBrowse{
	...
	protected DataSet getCiclos() throws Exception{
		...
		controlArchivoDAO.listarCiclos(_record.getValue("undinv_id"),null,null, false,false,getNumeroDePagina(),getPageSize(), ControlProcesosOpsMonedaLocal.PROCESO_OFERTA_ABONO_DICOM.getCiclo());/*TransaccionNegocio.CICLO_BATCH_ABONO_DICOM_OFERTA*/
	...
	protected String getTitulo(){
		return "Intercambio / Operaciones DICOM / Operaciones Demanda / Abono Operaciones / Consulta de Ciclo DICOM";
	}	
}
