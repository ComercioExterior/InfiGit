...
/** 
 * Clase que contiene los atributos que se registran en una tabla para conocer el usuario que efect&uacute;a una operaci&oacute;n sobre ella
 */
...
/**
 * Fecha de actualizaci&oacute;n del registro
 */
private Date actFechaHora;
 ...
 *
 */
public void setActFechaHora(Date actFechaHora ){
 ...
 *
 */
public void setInFechaHora(Date inFechaHora ){
