...
function CntnrSetUp(Wdth,Hght,NoOff){
	...
	//var x=RcrsLvl=='#ffffcc'?BorderColor:BorderSubColor;	
	//var x=RcrsLvl=='#ffffcc'?BorderColor:"#0B60B0";
	var x=RcrsLvl=='#fffcc'?BorderColor:"transparent";
	this.FrstMbr=null;
	...
	if(Nav4){	this.visibility='hide';
		...
		this.style.fontStyle=FontItalic?'Arial':'normal';
		//this.style.fontSize=FontSize+'pt';
		this.style.fontSize=FontSize="11";
...
function MbrSetUp(MmbrCntnr,PrMmbr,WhatMenu,Wdth,Hght){
	...
	var a,b,c,d;
	var Cmplnt=RcrsLvl==1?FCmplnt:SCmplnt;
	var LftXtra=(DomNav&&!Opr)||Cmplnt?LeftPaddng:4;
	var TpXtra=(DomNav&&!Opr)||Cmplnt?TopPaddng:4;
	this.PrvMbr=PrMmbr;
	this.Level=RcrsLvl;
	...
	if(RcrsLvl==1){
		//LowBgColor = "#C5CCFF";
		LowBgColor = "transparent";
		a=LowBgColor;
		b=HighBgColor="#C9C9C9";
		FontLowColor="#333333";
		c=FontLowColor;
		d=FontHighColor}
	else{ LowSubBgColor = "#EDEDED";
		a=LowSubBgColor;
		b=HighSubBgColor="#C9C9C9";
		FontSubLowColor="#333333";
		c=FontSubLowColor;
		d=FontSubHighColor="#FF0000";}
	this.LoBck=a;
	this.LwFntClr=c;
	this.HiBck=b;
	this.HiFntClr=d;
