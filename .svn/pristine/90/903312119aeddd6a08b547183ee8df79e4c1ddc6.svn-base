...
/** 
 * Clase encargada del proceso de b&uacute;squeda de los datos necesarios para los documentos de salida en el proceso de cancelaci&oacute;n de la orden
 */
public class FuncionCancelacion extends FuncionGenerica {
	...
	public void procesar(Object orden, java.lang.Object documentos, ServletContext contexto, String ip) throws Exception{
		...
		if (!ObjOrden.isOperacionVacio()){
			...
			OrdenOperacion opera = (OrdenOperacion) iter.next();
