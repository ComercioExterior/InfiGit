...
public class Browse extends ConsultaCicloPorParametroBrowse{
	...
	protected DataSet getCiclos() throws Exception{
		...
		controlArchivoDAO.listarCiclos(_record.getValue("undinv_id"),null,null, true,true,getNumeroDePagina(),getPageSize(), ControlProcesosOpsMonedaExtranjera.PROCESO_DEMANDA_ABONO_DICOM.getCiclo());
