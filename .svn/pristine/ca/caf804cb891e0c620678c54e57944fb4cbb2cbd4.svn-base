...
public class Generar extends MSCModelExtend {
	...
	public void execute() throws Exception {
		...
		Runnable abonoCuentaNacionalEnDolares= new AbonoCuentaNacionalMonedaExtranjera(_dso,Integer.parseInt(usu.idUserSession(getUserName())),this.getUserName(),Integer.parseInt(_record.getValue("undinv_id")),null);
	...
	public boolean isValid() throws Exception {
		...
		procesosDAO
				.listarPorTransaccionActiva(TransaccionNegocio.PROC_BATCH_CTA_NAC_MON_EXT_SUB_DIV_P_ENVIO);
