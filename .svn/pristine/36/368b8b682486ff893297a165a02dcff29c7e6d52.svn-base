...
public class Browse extends MSCModelExtend {
	...
	public void execute() throws Exception {		
		...
		inversionDAO.resumenParaCobroBatch(unidadInversionId,null,transacciones,StatusOrden.LIQUIDADA,StatusOrden.REGISTRADA,StatusOrden.NO_ADJUDICADA_INFI,StatusOrden.NO_CRUZADA);
		...
		inversionDAO.detalleCobroLiquidacionSubastaDivisas(unidadInversionId);
		...
		setSessionDataSet("listarUnidadesParaCobroLiqPorTipoProBatch", inversionDAO.getDataSet());
