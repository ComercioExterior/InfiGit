...
import models.intercambio.batch_adjudicacion.enviar_archivo.subasta.Detalle;
...
private String [] Transaccion ={TransaccionNegocio.TOMA_DE_ORDEN};
	...
	protected void getOperaciones() throws Exception{
		...
		operaciones = statement.executeQuery(inversionDAO.previoDeOperacionBatchPorIdOrden(ordenesIdEspecificos,_req.getParameter("undinv_id"),Transaccion,StatusOrden.ADJUDICADA,StatusOrden.NO_ADJUDICADA_INFI));		
	}
