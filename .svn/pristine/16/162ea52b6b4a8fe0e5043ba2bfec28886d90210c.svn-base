package models.intercambio.certificados_ORO.operaciones_ofertas.operaciones_cobros.consulta_ciclo;
...
public class Browse extends ConsultaCicloPorParametroBrowse{
	...
	protected DataSet getCiclos() throws Exception{
		...
		controlArchivoDAO.listarCiclos(_record.getValue("undinv_id"),null,null, true,true,getNumeroDePagina(),getPageSize(), ControlProcesosOpsMonedaExtranjera.PROCESO_OFERTA_COBRO_ORO.getCiclo()); /*TransaccionNegocio.CICLO_BATCH_COBRO_ORO_OFERTA*/
	...
	protected String getTitulo(){
		return "Intercambio / Operaciones ORO / Operaciones Oferta / Cobros Operaciones / Consulta de Ciclo ORO";
	}	
}
