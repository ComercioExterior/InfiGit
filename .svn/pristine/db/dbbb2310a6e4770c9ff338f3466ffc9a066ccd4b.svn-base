...
public class Browse extends MSCModelExtend {
	...
	public void execute() throws Exception {
		...
		try {
			...
			obtenerParametros();
			rutaRecepcion = parametrosRecepcionDICOM.get(ParametrosSistema.RUTA_OP_INTERBANCARIAS_DICOM_RECEP);
	...
	protected String getCarpetaRespaldo() {
		String carpeta = parametrosRecepcionDICOM.get(ParametrosSistema.RUTA_OP_INTERBANCARIAS_DICOM_RESP);
