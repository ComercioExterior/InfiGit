 ...
 * @author nvisbal
 */
public class LiquidacionBrowseSubastaDivisas extends MSCModelExtend{
	...
	public void execute() throws Exception {
		...
		ordenDAO.listarOrdenesLiquidacion(unidadInversion,ConstantesGenerales.ID_TIPO_PRODUCTO_SUBASTA_DIVISA_PERSONAL,StatusOrden.ADJUDICADA);	
