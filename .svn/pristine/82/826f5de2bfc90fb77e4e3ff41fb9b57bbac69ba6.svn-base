...
public class Browse extends MSCModelExtend {
	...
	public void execute() throws Exception {
		...
		inversionDAO.resumenParaCobroBatch(unidadInversionId,null,transacciones,StatusOrden.ENVIADA);
		...
		setSessionDataSet("listarUnidadesParaCobroAdjBatchDicom", inversionDAO.getDataSet());
