 ...
 */
public class PlantillasMailAreaConfirmUpdate extends MSCModelExtend{
	...
	private void obtenerAreas() throws Exception {		
		...
		if(areas!=null){
			...
			for(int i=0; i< areas.length; i++){
				...
				plantillaMailArea.setPlantMailAreaId(Integer.parseInt(_req.getParameter("plant_mail_area_id_"+areas[i])));
