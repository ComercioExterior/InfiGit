...
public class Browse extends MSCModelExtend {
	...
	public void execute() throws Exception {
		...
		//inversionDAO.resumenParaCobroBatch(unidadInversionId,null,transacciones,StatusOrden.REGISTRADA);
		//archivosOpsDAO.getOperacionesDicomResumen(unidadInversionId, TransaccionNegocio.ORDEN_PAGO, StatusOrden.REGISTRADA);
		...
		//inversionDAO.detalleCobroSubastaDivisas(unidadInversionId,StatusOrden.REGISTRADA);
		//DataSet registros = inversionDAO.getDataSet();
		archivosOpsDAO.getOperacionesDicomDetalle(String.valueOf(unidadInversionId), TransaccionNegocio.ORDEN_PAGO, StatusOrden.REGISTRADA);
		...
		setSessionDataSet("listarUnidadesParaAbonoBatchDicom", inversionDAO.getDataSet());
