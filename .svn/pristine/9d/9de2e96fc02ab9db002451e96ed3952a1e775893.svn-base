package models.custodia.informes.facturas_cobradas;
...
public class View extends AbstractModel {
	...
	public void execute() throws Exception {
		...
		String mes = _record.getValue("mes");
		...
		parametrosJasper.put("p_titulo_reporte", "FACTURAS COBRADAS AL: ");
		...
		String rango_desde = "to_date("+desde+",'dd-mm-yyyy')";
		...
		String statusA = "('"+ConstantesGenerales.STATUS_EN_ESPERA+"','"+ConstantesGenerales.STATUS_RECHAZADA+"')";
		String statusB = "'"+ConstantesGenerales.STATUS_APLICADA+"'";
		...
		parametrosJasper.put("p_query_status", statusA);
		parametrosJasper.put("p_query_status_aplicada", statusB);
		parametrosJasper.put("p_query_orderby", " order by c.client_nombre asc ");
		...
		String archivoJasper = _app.getRealPath("WEB-INF") + separador + "templates" + separador + "informes" + separador + "custodia" + separador + "facturasCobradas.jasper";
