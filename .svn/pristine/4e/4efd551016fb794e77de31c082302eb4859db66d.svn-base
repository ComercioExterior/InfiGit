package models.intercambio.operaciones_DICOM.operaciones_ofertas.operaciones_cobros.envio_archivo;
...
public class Browse extends MSCModelExtend {
	...
	public void execute() throws Exception {
		...
		//inversionDAO.resumenParaCobroBatchDicom(unidadInversionId,ConstantesGenerales.ID_TIPO_PRODUCTO_DICOM,TransaccionNegocio.TOMA_DE_ORDEN,StatusOrden.ENVIADA);
		archivosOpsDAO.getOperacionesDicomResumen(unidadInversionId, TransaccionNegocio.TOMA_DE_ORDEN, StatusOrden.ENVIADA);
		...
		//inversionDAO.detalleCobroSubastaDivisas(unidadInversionId,StatusOrden.ENVIADA);
		archivosOpsDAO.getOperacionesDicomDetalle(String.valueOf(unidadInversionId), TransaccionNegocio.TOMA_DE_ORDEN, StatusOrden.ENVIADA);
		//inversionDAO.detalleOperacionesDicom(unidadInversionId, TransaccionNegocio.TOMA_DE_ORDEN , StatusOrden.ENVIADA, 0);
		...
		setSessionDataSet("listarUnidadesParaCobroBatchOfertaDicom", inversionDAO.getDataSet());
