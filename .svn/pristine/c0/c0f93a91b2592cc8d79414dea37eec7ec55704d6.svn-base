...
public class OperCamFileTransfer_ServiceLocator extends org.apache.axis.client.Service implements OperCamFileTransfer_Service {
    ...
    public org.bcv.serviceDICOMInterbancario.OperCamFileTransfer_PortType getOperCamFileTransferPort() throws javax.xml.rpc.ServiceException {
    ...
    public OperCamFileTransfer_PortType getOperCamFileTransferPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            OperCamFileTransferPortBindingStub _stub = new OperCamFileTransferPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (OperCamFileTransfer_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                OperCamFileTransferPortBindingStub _stub = new OperCamFileTransferPortBindingStub(new java.net.URL(OperCamFileTransferPort_address), this);
                _stub.setPortName(getOperCamFileTransferPortWSDDServiceName());
                return _stub;
            }
        }
