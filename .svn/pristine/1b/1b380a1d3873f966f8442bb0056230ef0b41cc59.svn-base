...
public class EnvioCorreosConsultar extends AbstractModel {
...
//		storeDataSet("tipos_dest", plantillasMailDAO.getDataSet()); //Registra el dataset exportado por este modelo
		...
		plantillasMailDAO.obtenerStatusCorreos(ec); //Obtiene los estatus de los correos
		storeDataSet("status_correos", plantillasMailDAO.getDataSet()); //Registra el dataset exportado por este modelo
...
//		}
		...
		if(valido && eventoId!=null && !eventoId.equals("")){
			...
			pm.setEstatusActivacion(ConstantesGenerales.VERDADERO+"");
...
//				}
				...
				mensError = "<span style=\"color:red;\">Error:</span> No se encontr&oacute; ninguna plantilla activa para el estatus de orden: "+_req.getParameter("name_status_orden_plant")+", la transacci&oacute;n: "+_req.getParameter("name_transac_plant")+" y el tipo de destinatario: "+_req.getParameter("name_dest");
				Logger.info(this, "ENVIO CORREOS: No se encontr&oacute; ninguna plantilla activa para el estatus de orden: "+_req.getParameter("name_status_orden_plant")+", la transacci&oacute;n: "+_req.getParameter("name_transac_plant")+" y el tipo de destinatario: "+_req.getParameter("name_dest"));
				//valido = false;
