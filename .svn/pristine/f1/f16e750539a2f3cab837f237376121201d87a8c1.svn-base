...
public class Browse extends MSCModelExtend {
	...
	public void execute() throws Exception {
		...
		archivosOpsDAO.getOperacionesOROResumen(unidadInversionId, TransaccionNegocio.TOMA_DE_ORDEN, StatusOrden.ENVIADA);
		...
		archivosOpsDAO.getOperacionesORODetalle(String.valueOf(unidadInversionId), TransaccionNegocio.TOMA_DE_ORDEN, StatusOrden.ENVIADA);
		...
		setSessionDataSet("listarUnidadesParaCobroBatchOfertaORO", inversionDAO.getDataSet());
