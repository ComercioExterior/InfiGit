package models.intercambio.batch_liquidacion.consulta.clavenet_personal.subasta_divisas_personal;
...
public class Browse extends ConsultaCicloPorParametroBrowse{
	...
	protected DataSet getCiclos() throws Exception{
		...
		//controlArchivoDAO.listarCiclos(_record.getValue("undinv_id"),null,null, TransaccionNegocio.CICLO_BATCH_SUBASTA_DIVISAS_PERSONAL, false,true,getNumeroDePagina(),getPageSize());
		controlArchivoDAO.listarCiclos(_record.getValue("undinv_id"),null,null, false,true,getNumeroDePagina(),getPageSize(), TransaccionNegocio.CICLO_BATCH_SUBASTA_DIVISAS_PERSONAL,TransaccionNegocio.CICLO_BATCH_SICADII_CLAVENET_PERSONAL,TransaccionNegocio.CICLO_BATCH_SICADII_RED_COMERCIAL);
	...
	protected String getTitulo(){
		return "Intercambio / Cobro Liquidacion Batch / Consulta Ciclo Consulta Ciclo SICAD II";
	}	
}
