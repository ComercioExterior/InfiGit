...
public interface ParametrosSistema {
	...
	/**
	 * NOMBRE DEL ARCHIVO SWIFT QUE SE DEJARÁ EN LA COLA DE CUSTODIA
	 */
	public static final String SWIFT_NOM_CUSTOVALORES="SWIFT-NOM-CUSTOVALORES";
	/**
	 * NOMBRE DEL ARCHIVO SWIFT QUE SE DEJARÁ EN LA COLA DE TESORERIA
	 */
	public static final String SWIFT_NOM_TESORERIA="SWIFT-NOM-TESORERIA";
	/**
	 * NOMBRE DEL ARCHIVO SWIFT QUE SE DEJARÁ EN LA COLA DE CLAVENET PERSONAL
	 */
	public static final String SWIFT_NOM_CLAVENET_PERSONAL="SWIFT-NOM-CLAVENET-P";
	/**
	 * DIRECTORIO DONDE SE ALMACENARÁN LOS ARCHIVOS SWIFT CON OPERACIONES RELACIONADAS A CUSTODIA
	 */
	public static final String SWIFT_COLA_CUSTOVALORES="SWIFT-COLA-CUSTOVALORES";
	/**
	 * DIRECTORIO DONDE SE ALMACENARÁN LOS ARCHIVOS SWIFT CON OPERACIONES RELACIONADAS A TESORERIA
	 */
	public static final String SWIFT_COLA_TESORERIA="SWIFT-COLA-TESORERIA";
	/**
	 * DIRECTORIO DONDE SE ALMACENARÁN LOS ARCHIVOS SWIFT CON OPERACIONES RELACIONADAS A CLAVENET PERSONAL
	 */
	...
	/**
	 * Constante para buscar el indicador de control de cambio en los parámetros generales del sistema
	 */
	...
	/**
	 * Ruta y nombre del archivo donde estara ubicado usuario y contraseña FTP
	 */
	...
	/**
	 * Valor de observación que llevarán algunos informes de custodia
	 */
	...
	//----------------Parámetros de la interfaz de OPS
...
//INTERFAZ PARA CERTIFICADO EN ORO PARAMETROS DE BASE DE DATOS
	...
	/**
	 * Mensaje a mostrar en la toma de ordenes Subasta Divisas por Red Comercial en caso de no cumplir con la banda de tasas propuestas configuradas en la Unidad de Inversión
	 */
