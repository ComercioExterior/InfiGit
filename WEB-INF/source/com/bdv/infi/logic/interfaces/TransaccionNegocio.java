...
public class TransaccionNegocio {
	...
	/**Transaccion de adjudicación*/
	public static final String ADJUDICACION = "ADJUDICACION";
	
	/**Transaccion de adjudicación para la subasta de divisas*/
	...
	/**Cancelación de una unidad de inversión*/
	...
	/**Orden de pago. Puede ser de cupón o capital*/
	public static final String ORDEN_PAGO = "ORDEN_PAGO";	
	
	/**Orden de un vehículo*/
	...
	/**Proceso de actualización de clientes en OPICS*/
	public static final String PROC_ACT_CLIENTES_OPICS = "PROC_ACT_CLIENTES_OPICS";
	
	/**Proceso de actualización de estatus de ordenes en Exportacion de Ordenes INFI*/
	...
	/**Proceso de generación de archivos de las diferentes interfaces  */
	...
	/**Transaccion relacionada con el proceso de envío de correos*/
