...
public class Movimientos extends AutorizacionStub{
	...
	public void lecturaMovimientoBcv() {
		...
		cltMenudeo.IdOrdenes = codigoOperacion;
		...
		cltMenudeo.MontoTransaccion = MontoTrans.setScale(2,RoundingMode.DOWN);
...
System.out.println("llegoooooooo");
		org.w3c.dom.Node ele = nodo;
		System.out.println("TIPO MOVIMIENTO : "+ ((org.w3c.dom.Element) ele).getElementsByTagName("TIMOVIMIENTO").item(0).getTextContent());
		if (!((org.w3c.dom.Element) ele).getElementsByTagName("TIMOVIMIENTO").item(0).getTextContent().contains("ANU")) {
			String codigoOperacion = ((org.w3c.dom.Element) ele).getAttribute("ID");
			String cliente = ((org.w3c.dom.Element) ele).getElementsByTagName("CLIENTE").item(0).getTextContent();
			String fecha = ((org.w3c.dom.Element) ele).getElementsByTagName("FECHA").item(0).getTextContent();
			String montoBase = ((org.w3c.dom.Element) ele).getElementsByTagName("MONTOTRANS").item(0).getTextContent();
