...
public class PlantillasMailUpdate extends MSCModelExtend {
	...
	public void execute() throws Exception {
		...
		plantillaMail.setPlantillaMailId(Integer.parseInt(_record.getValue("plantilla_mail_id")));
		...
		String[] consulta = plantillasMailDAO.actualizar(plantillaMail);
