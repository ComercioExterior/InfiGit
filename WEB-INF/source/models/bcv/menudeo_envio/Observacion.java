...
public class Observacion extends MSCModelExtend {
	...
	public void execute() throws Exception {
		...
		ordenesCrucesDAO.listarOrdenesPorEnviarMenudeoBCV1(false, true, getNumeroDePagina(),getPageSize(), true, statusP, fecha,statusE,Tipo,"",clienteID,true,combustible);
