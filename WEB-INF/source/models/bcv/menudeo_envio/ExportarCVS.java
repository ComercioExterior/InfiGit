...
public class ExportarCVS extends ExportableOutputStream {
	...
	public void execute() throws Exception {
		...
		ordenesCrucesDAO.listarOrdenesPorEnviarMenudeoBCV1(false, true, 0, 0, true, statusP, fecha, statusE, Tipo, "", clienteID,true,combustible);
	...
	public void capturarValoresRecord() throws Exception {
		...
		this.combustible = _record.getValue("combustiblee");
System.out.println("combustiblecombustiblecombustiblecombustible : " + combustible);
