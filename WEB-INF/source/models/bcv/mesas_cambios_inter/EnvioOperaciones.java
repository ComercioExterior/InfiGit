...
public class EnvioOperaciones extends AbstractModel implements Runnable {
	...
	public EnvioOperaciones(int numeroDePagina, int pageSize, boolean todos, String idOrdenes, String statusP, DataSource _dso, int idUsuario, String fecha, String statusE, String Tipo, String tipoMovimiento) {
...
//	}
	...
	public void run() {
		// INCIAR PROCESO
		try {
			Logger.info(this,"EnvioOperaciones Interbancarias : **Comienzo de envio de operaciones Mesa de Cambio**");
			
			if(verificarCiclo(TransaccionNegocio.WS_BCV_IMESAS)){
				iniciarProceso();
				MesaIntercambio procesoMesa = new MesaIntercambio(_dso);
				
				switch (procesoMesa.Iniciar(Tipo,fecha,statusE,statusP,idOrdenes,tipoMovimiento)) {
				case 0:
	...
	protected void iniciarProceso() throws Exception {
		...
		proceso.setTransaId(TransaccionNegocio.WS_BCV_IMESAS);
