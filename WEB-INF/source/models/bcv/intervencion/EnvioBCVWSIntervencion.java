...
public class EnvioBCVWSIntervencion extends AbstractModel implements Runnable {
	...
	public EnvioBCVWSIntervencion(int numeroDePagina, int pageSize, boolean todos, String idOrdenes, String urlInvocacion, DataSource _dso, int idUsuario, String fecha, String statusE, String Jornada, String moneda) {
...
//				}
	...
	public void llenarDataSetOperaciones() {
		...
		try {
			...
			IntervencionDao.listarOrdenesIntervencion(fecha, estatusEnvio, todos, idOrdenes, moneda);
