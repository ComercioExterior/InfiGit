...
public class Procesar extends MSCModelExtend {
	...
	public void execute() throws Exception {
		...
		try {
			EnvioBCVWSMenudeo envioBCVWSMenudeo = new EnvioBCVWSMenudeo(incluirCliente,clienteID,tasaMinima,tasaMaxima,montoMinimo,montoMaximo,idUnidad, getNumeroDePagina(), getPageSize(), todos, incluir, idOrdenes, statusP, urlInvocacion, _dso, idUsuario, fecha);
