package models.intercambio.recepcion.cruce_sicad_II.download_plantilla;
	...
	public void execute() throws Exception {
		...
		String rutaTemplate 		= _app.getRealPath("WEB-INF") + separador;
		 ...
		 if(_req.getParameter("nombre").equals(ConstantesGenerales.INDICADOR_CRUCE)){			 
			rutaTemplate += ConstantesGenerales.DIR_TEMPLATE_CRUCE + separador + ConstantesGenerales.ARCH_TEMPLATE_CRUCE + ConstantesGenerales.EXTENSION_DOC_XLS;
			nombreFinal = ConstantesGenerales.ARCH_TEMPLATE_CRUCE + ConstantesGenerales.EXTENSION_DOC_XLS;
		} else if (_req.getParameter("nombre").equals(ConstantesGenerales.INDICADOR_NO_CRUCE)) {		
			rutaTemplate += ConstantesGenerales.DIR_TEMPLATE_CRUCE + separador + ConstantesGenerales.ARCH_TEMPLATE_NO_CRUCE + ConstantesGenerales.EXTENSION_DOC_XLS;
			nombreFinal = ConstantesGenerales.ARCH_TEMPLATE_NO_CRUCE + ConstantesGenerales.EXTENSION_DOC_XLS;
		}
