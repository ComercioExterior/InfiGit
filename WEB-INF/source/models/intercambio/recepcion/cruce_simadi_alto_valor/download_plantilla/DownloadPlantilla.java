package models.intercambio.recepcion.cruce_simadi_alto_valor.download_plantilla;
	...
	public void execute() throws Exception {
		...
		String rutaTemplate 		= _app.getRealPath("WEB-INF") + separador;
		 ...
		 if(_req.getParameter("nombre").equals(ConstantesGenerales.INDICADOR_CRUCE)){			 
			rutaTemplate += ConstantesGenerales.DIR_TEMPLATE_CRUCE + separador + ConstantesGenerales.ARCH_TEMPLATE_CRUCE_SIMADI_AV + ConstantesGenerales.EXTENSION_DOC_XLS;
			nombreFinal = ConstantesGenerales.ARCH_TEMPLATE_CRUCE_SIMADI_AV + ConstantesGenerales.EXTENSION_DOC_XLS;
		} else if (_req.getParameter("nombre").equals(ConstantesGenerales.INDICADOR_NO_CRUCE)) {		
			rutaTemplate += ConstantesGenerales.DIR_TEMPLATE_CRUCE + separador + ConstantesGenerales.ARCH_TEMPLATE_NO_CRUCE_SIMADI_AV + ConstantesGenerales.EXTENSION_DOC_XLS;
			nombreFinal = ConstantesGenerales.ARCH_TEMPLATE_NO_CRUCE_SIMADI_AV + ConstantesGenerales.EXTENSION_DOC_XLS;
		}
