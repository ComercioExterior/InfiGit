...
public class DetalleDeOperaciones extends ExportableOutputStream {

	Logger logger = Logger.getLogger(DetalleDeOperaciones.class);
	/**
	...
	protected void getOperaciones() throws Exception{
		operaciones = statement.executeQuery(inversionDAO.detalleDeOperacionBatchPorUnidadLiquidacion(Integer.parseInt(_record.getValue("undinv_id")), false));
	}
