...
public class Browse extends ConsultaCicloPorParametroBrowse{
	...
	protected DataSet getCiclos() throws Exception{
		...
		controlArchivoDAO.listarCiclos(_record.getValue("undinv_id"),null,null, false,false,getNumeroDePagina(),getPageSize(), ControlProcesosOpsMonedaLocal.PROCESO_OFERTA_ABONO_ORO.getCiclo());/*TransaccionNegocio.CICLO_BATCH_ABONO_DICOM_OFERTA*/
