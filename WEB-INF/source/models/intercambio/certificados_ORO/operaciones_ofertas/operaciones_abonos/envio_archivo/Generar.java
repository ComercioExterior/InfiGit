...
public class Generar extends MSCModelExtend {
	...
	public void execute() throws Exception {
		...
		/***************/
		int transaccionFinanciera=1;//Tipo de transaccion que define si es capital (1) o comision (11) o 0 (cero que representa ambas transacciones)		
	...
	public boolean isValid() throws Exception {
		...
		this.controlProceso=ControlProcesosOpsMonedaLocal.PROCESO_OFERTA_ABONO_ORO.getInstance();
		...
		if (procesosDAO.getDataSet().count() > 0) {
			...
			if (dataSet.count() > 0){
				...
				_record
				.addError(
						"Proceso ORO Abono Oferta Batch",
