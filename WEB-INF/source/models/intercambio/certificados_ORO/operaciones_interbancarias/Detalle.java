		...
		{	
			...
			try{			
				...
				if(directorio==null||directorio==""){
					...
					//directorio =  parametrosRecepcionORO.get(ParametrosSistema.RUTA_DICOM_RESP);
					directorio =  parametrosRecepcionORO.get(ParametrosSistema.RUTA_OP_INTERBANCARIAS_ORO_RECEP);
