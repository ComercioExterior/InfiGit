...
public class Browse extends ConsultaCicloBrowse{
	...
	protected DataSet getCiclos() throws Exception{
		...
		controlArchivoDAO.listarCiclos(_record.getValue("undinv_id"),_record.getValue("fe_desde"), _record.getValue("fe_hasta"), TransaccionNegocio.CICLO_BATCH_SUBASTA, true,true,getNumeroDePagina(),getPageSize());
	...
	protected String getTitulo(){
		return "Intercambio / Cobro Adjudicación Batch / Consulta Ciclo Subasta";
	}	
}
