...
public class OperCamFileTransfer_ServiceLocator extends org.apache.axis.client.Service implements org.bcv.serviceDICOM.OperCamFileTransfer_Service {
    ...
    public org.bcv.serviceDICOM.OperCamFileTransfer_PortType getOperCamFileTransferPort() throws javax.xml.rpc.ServiceException {
    ...
    public org.bcv.serviceDICOM.OperCamFileTransfer_PortType getOperCamFileTransferPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	org.bcv.serviceDICOM.OperCamFileTransferPortBindingStub _stub = new org.bcv.serviceDICOM.OperCamFileTransferPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.bcv.serviceDICOM.OperCamFileTransfer_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
            	org.bcv.serviceDICOM.OperCamFileTransferPortBindingStub _stub = new org.bcv.serviceDICOM.OperCamFileTransferPortBindingStub(new java.net.URL(OperCamFileTransferPort_address), this);
                _stub.setPortName(getOperCamFileTransferPortWSDDServiceName());
                return _stub;
            }
        }
