...
//	email :	fuushikaden@yahoo.com
    ...
    */
	...
	/*----------- Configuración español. Comentar para desactivar  -------------*/
	monthName = new Array("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre");
	dayName = new Array ("Lu","Ma","Mi","Ju","Vi","Sá","Do");
	startAt = 1;
	gotoString = "Obtiene el Mes actual";
	todayString = "Hoy es";
	weekString = "Semana";
	scrollLeftMessage = "Click para mostrar el Mes previo. Mantenga presionado para mostrar automáticamente.";
	scrollRightMessage = "Click para mostrar el Mes próximo. Mantenga presionado para mostrar automáticamente.";
	selectMonthMessage = "Click para seleccionar un Mes.";
	selectYearMessage = "Click para seleccionar un Año.";
	selectDateMessage = "Seleccione [date] como fecha."; // do not replace [date], it will be replaced by date.
  	imgDir = "../js/calendar/";	// directory for images ... e.g. var imgDir="/img/"
  /*---------------------------------------------------------------------------*/
