...
Menu1_1=new Array("Aplicaciones","aplicacion-find","",0,25,176);           

Menu1_2=new Array("Opciones del Menú","menu_items-find","",0,25,170);           

Menu1_3=new Array("Roles","msc_role-find","",0,25,170);           

Menu1_4=new Array("Roles / Menú","menu_role-find","",0,25,170);           

Menu1_5=new Array("Usuarios","msc_user-find","",0,25,170);           

Menu1_6=new Array("Cambio de Password","password","",0,25,170);           

Menu1_7=new Array("Consultas","","",2,25,170);           

Menu1_7_1=new Array("Opciones de Menú por Roles","consulta_opciones_roles-find","",0,25,170);           

Menu1_7_2=new Array("Opciones de Menú por URL","consulta_opciones_url-find","",0,25,170);           

Menu1=new Array("SEGURIDAD","","",7,25,170);           

Menu2=new Array("Salir","j_logout","",0,25,170);           
